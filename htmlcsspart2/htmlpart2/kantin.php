    ...
    <?php include('nav.php'); ?>
            <div class="content1">
                <div class="text1">
                  ...
                  <img src="img/piring.jpeg" />
           </div>
           <div class="content2">
            <div class="card">
                <h2><b>penunjang kesehatan</b></h2> 
                <p>peserta didik sangat diperhatikan, mulai dari cara pengolahan makan, sarana yang digunakan, penjamah (pelayan) makanan, kebersihan tempat, serta perilaku konsumen. Menu makanan yang dijajakan di kantin sehat SMK Wikrama sangat beragam. Beberapa makanan yang diproduksi koki Wikrama antara lain, makanan berat (nasi dan berbagai lauknya), soto, mie ayam, dan sebagainya.</p> 
            </div>
            <div class="card">
                <h2><b>menjadi sumber penghasilan bagi warga sekitar</b></h2> 
                <p>karena ada beberapa makanan yang dipasok dari luar. Akan tetapi makanan tersebut tetap harus memerhatikan beberapa ketentuan yang telah ditetapkan. Pertama tidak boleh menggunakan plastik atau kertas (sesuai budaya Wikrama), dilarang menggunakan zat berbahaya dalam makanan (vetsin, pewarna tekstil, formalin dan sebagainya). Kemudian tidak diperkenankan juga menjual makanan yang menggunakan bumbu perasa (rasa jagung, keju, dan sebagainya).</p> 
            </div>
        </div>
       
        <div class="content4">
            <h2>Feri Firmansyah selaku pembina kantin sehat mengemukakan</h2>
            <p>“Evaluasi penilaian tersebut yaitu bahwa kantin sehat perlu meerhatikan cara penanganan hama serta cara menyimpan makanan mentah dan matang perlu diperhatikan lagi.”</p>
