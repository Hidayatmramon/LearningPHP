...
<div class="responsive">
    <div class="gallery">
        <a target="_blank" href="img/html.png">
            <img src="img/html.png" width="600" height="400">
        </a>
...
<div class="responsive">
    <div class="gallery">
        <a target="_blank" href="img/css.png">
            <img src="img/css.png" width="600" height="400">
        </a>
...
<div class="responsive">
    <div class="gallery">
        <a target="_blank" href="img/python.jpg">
            <img src="img/python.jpg" width="600" height="400">
        </a>
...
<div class="responsive">
    <div class="gallery">
        <a target="_blank" href="img/php.png">
            <img src="img/php.png" width="600" height="400">
        </a>
